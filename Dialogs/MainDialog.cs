...
namespace ChatBot.Dialogs
{
    public class MainDialog : ComponentDialog
    {
        ...
        public MainDialog(BankOperationRecognizer cluRecognizer, OpenAccounDialog openAccounDialog, CheckAccountBalanceDialog checkAccountBalanceDialog, ILogger<MainDialog> logger)
